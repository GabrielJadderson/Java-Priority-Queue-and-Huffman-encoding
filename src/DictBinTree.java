...
public class DictBinTree implements Dict
{
    ...
    /**
     * <font color="#448484">Inserts a key in the dictionary.</font>
    ...
    public void insert(int k)
    {
        ...
        if(y == null) {
            ...
            root = new Node(k);
        } else if(k < y.data) { //Otherwise, place the new node either left or right depending on the relation between the new key and the key in y.
            y.left = new Node(k);
        } else {
            y.right = new Node(k);
        }
    ...
    /**
     * <font color="#448484">This method creates a sorted array of all the keys in the dictionary and returns it. The array is sorted in nondescending order.</font>
    ...
    /**
     * <font color="#448484">This method recursively traverses the tree and inserts the contents of its right subtree in the array, then its own element and then the contents of its right subtree. This is done using the static mark variable in the class, which makes this method not thread safe, even with synchronized blocks.</font>
    ...
    /**
     * <font color="#448484">This method takes searches for a key in the dictionary and return true if it exists and false if it doesn't.</font>
